...
function PageHero(){
  ...
  return(
    <section style={{position:"relative",height:"62vh",minHeight:480,overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",inset:0,background:"linear-gradient(135deg,rgba(52,105,136,0.88) 35%,rgba(52,105,136,0.4) 100%)"}}/>
      ...
      <div style={{position:"relative",zIndex:5,height:"100%",maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",paddingTop:"clamp(140px,16vw,165px)",display:"flex",flexDirection:"column",justifyContent:"flex-end",paddingBottom:"clamp(2rem,3vw,3.5rem)"}}>
        ...
        <h1 className="font-display" style={{fontSize:"clamp(2.6rem,5.5vw,4.5rem)",fontWeight:600,lineHeight:1.05,color:"#fff",marginBottom:"0.8rem",opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(20px)",transition:"all 0.8s ease 0.4s"}}>
          A Vibrant International<br/><span style={{fontStyle:"italic",color:"var(--accent-light)"}}>Learning Community</span>
        </h1>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(2rem,4vw,3.5rem)",alignItems:"start"}} className="int-welcome-grid">
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:"all 0.9s ease 0.1s"}}>
          ...
          <div style={{display:"flex",gap:"0.75rem",flexWrap:"wrap"}}>
            <a href="/granada-international#admissions" className="btn-solid">Enquire Now</a>
        ...
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(24px)",transition:"all 0.9s ease 0.2s"}}>
          ...
          <div style={{borderLeft:"3px solid var(--primary)",paddingLeft:"clamp(0.8rem,1.5vw,1.2rem)"}}>
            ...
            <p style={{color:"var(--primary)",fontSize:"clamp(0.6rem,0.75vw,0.68rem)",letterSpacing:"0.14em",textTransform:"uppercase",fontWeight:700}}>
              The Principal<br/><span style={{color:"var(--muted)",fontWeight:400,textTransform:"none",letterSpacing:"normal",fontSize:"0.8rem"}}>Granada International</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <section className="section-blue" id="boarding" ref={ref} style={{paddingTop:"clamp(3rem,6vw,5rem)",paddingBottom:"clamp(3rem,6vw,5rem)",scrollMarginTop:"100px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(2rem,4vw,4rem)",alignItems:"center",marginBottom:"clamp(2rem,3vw,3rem)"}} className="int-boarding-grid">
        <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(-24px)",transition:"all 0.9s ease"}}>
          ...
          <a href="/granada-international#admissions" className="btn-solid">Enquire About Boarding</a>
        </div>
    ...
    <footer id="contact" style={{background:"var(--primary-dark)",color:"#fff",padding:"clamp(3rem,4vw,4.5rem) clamp(1rem,2vw,2rem) clamp(1.2rem,2vw,2rem)"}}>
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        ...
        <div style={{borderTop:"1px solid rgba(255,255,255,0.1)",paddingTop:"1.6rem",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"1rem"}}>
          <p style={{color:"rgba(255,255,255,0.4)",fontSize:"0.7rem"}}>© {new Date().getFullYear()} Granada International. All rights reserved.</p>
