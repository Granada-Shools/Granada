...
const NAV_ITEMS = [
  {label:"About Us",href:"/granada-international/about",image:"/building.jpeg",imageCaption:"A Unique Blend of Discovery + Purpose",
    children:[{label:"Principal's Welcome",href:"/granada-international/about#welcome"},{label:"Vision & Aims",href:"/granada-international/about#vision"},{label:"Our Values",href:"/granada-international/about#values"},{label:"Our Story",href:"/granada-international/about#history"},{label:"Boarding",href:"/granada-international/about#boarding"},{label:"Staff & Leadership",href:"/granada-international/about#staff"}]},
    ...
    <div style={{position:"fixed",top:0,right:0,bottom:0,zIndex:200,width:"100%",maxWidth:"min(100vw,900px)",display:"flex",flexDirection:"column",background:"#346988",transform:open?"translateX(0)":"translateX(100%)",transition:"transform 0.5s cubic-bezier(0.77,0,0.175,1)",boxShadow:"-8px 0 60px rgba(0,0,0,0.3)"}}>
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"clamp(0.8rem,2vw,1.1rem) clamp(1.5rem,3vw,2.5rem)",borderBottom:"1px solid rgba(255,255,255,0.1)",flexShrink:0,gap:"clamp(0.8rem,2vw,1.5rem)",background:"rgba(0,0,0,0.2)",flexWrap:"wrap"}}>
        ...
        <div style={{flex:1,maxWidth:280,position:"relative"}}>
          ...
          {search.trim()&&sr.length>0&&(
            <div style={{position:"absolute",top:"calc(100% + 4px)",left:0,right:0,background:"#fff",border:"1px solid rgba(52,105,136,0.3)",zIndex:10,maxHeight:240,overflowY:"auto",boxShadow:"0 4px 20px rgba(0,0,0,0.1)"}}>
              {sr.map((r,i)=>(
                <a key={i} href={r.href} onClick={()=>{setSearch("");onClose();}} style={{display:"block",padding:"0.6rem 1rem",color:"#1c1b1c",textDecoration:"none",fontSize:"0.8rem",borderBottom:"1px solid #f0eee9",transition:"background 0.15s"}} onMouseEnter={e=>(e.currentTarget.style.background="rgba(52,105,136,0.08)")} onMouseLeave={e=>(e.currentTarget.style.background="transparent")}>{r.label}</a>
              ))}
            </div>
          )}
        </div>
        <button onClick={onClose} style={{background:"none",border:"1px solid rgba(255,255,255,0.4)",color:"#fff",width:"clamp(32px,6vw,36px)",height:"clamp(32px,6vw,36px)",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all 0.2s"}}
          onMouseEnter={e=>{e.currentTarget.style.background=S;e.currentTarget.style.color="#346988";}} onMouseLeave={e=>{e.currentTarget.style.background="none";e.currentTarget.style.color="#fff";}} aria-label="Close">
      ...
      <div style={{flex:1,display:"flex",overflow:"hidden"}}>
        ...
        <div style={{flex:1,display:"flex",overflow:"hidden"}}>
          ...
          <div style={{width:"clamp(150px,20vw,320px)",flexShrink:0,position:"relative",overflow:"hidden",background:"#346988",display:"none"}} className="cl-nav-img">
            {NAV_ITEMS.map((item,i)=>(
        ...
        <div style={{display:"flex",gap:"0.65rem",alignItems:"center"}}>
          {[{k:"FB",i:<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>},{k:"IG",i:<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>},{k:"LI",i:<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>},{k:"TW",i:<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>}].map(({k,i})=>(
            <a key={k} href="#" style={{width:28,height:28,border:"1px solid rgba(255,255,255,0.4)",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontSize:"0.55rem",fontWeight:700,textDecoration:"none",transition:"all 0.2s"}}
              onMouseEnter={e=>{e.currentTarget.style.background=S;e.currentTarget.style.color="#346988";}} onMouseLeave={e=>{e.currentTarget.style.background="transparent";e.currentTarget.style.color="#fff";}}>{i}</a>
          ))}
        </div>
    ...
    <header style={{position:"fixed",top:0,left:0,right:0,zIndex:100,transition:"all 0.4s ease",background:scrolled?"rgba(255,255,255,0.97)":"transparent",backdropFilter:scrolled?"blur(10px)":"none",boxShadow:scrolled?"0 1px 0 #e8e6e3":"none",padding:scrolled?"0.7rem 0":"clamp(0.8rem,2vw,1.2rem) 0"}}>
      <div style={{maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"0.5rem"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:"clamp(1rem,2vw,1.5rem)",flexWrap:"wrap",justifyContent:"flex-end",flex:1}}>
          <button onClick={()=>setOpen(true)} aria-label="Open menu" style={{background:"none",border:`1px solid ${scrolled?"rgba(52,105,136,0.35)":"rgba(255,255,255,0.5)"}`,cursor:"pointer",display:"flex",flexDirection:"column",gap:5,padding:"0.5rem 0.6rem",transition:"border-color 0.3s"}} onMouseEnter={e=>(e.currentTarget.style.borderColor="var(--primary)")} onMouseLeave={e=>(e.currentTarget.style.borderColor=scrolled?"rgba(52,105,136,0.35)":"rgba(255,255,255,0.5)")}>
...
function PageHero(){
  ...
  useEffect(()=>{setLoaded(true);const t=setInterval(()=>setSlide(s=>(s+1)%slides.length),5500);return()=>clearInterval(t);},[]);
  return(
    <section style={{position:"relative",height:"75vh",minHeight:580,overflow:"hidden"}}>
      {slides.map((s,i)=>(
        <div key={i} style={{position:"absolute",inset:0,backgroundImage:`url(${s})`,backgroundSize:"cover",backgroundPosition:"center",opacity:i===slide?1:0,transition:"opacity 1.4s ease",animation:i===slide?"clKenBurns 12s ease-in-out infinite alternate":"none"}}/>
      ))}
      <div style={{position:"absolute",inset:0,background:"linear-gradient(160deg,rgba(67,107,13,0.85) 0%,rgba(52,105,136,0.7) 50%,rgba(13,12,13,0.5) 100%)"}}/>
      ...
      <div style={{position:"absolute",top:"clamp(100px,22%,200px)",right:"3%",zIndex:5,display:"flex",flexDirection:"column",gap:"0.6rem",alignItems:"flex-end"}}>
        {[{color:"#aac20c",label:"Sports"},{color:"#936c51",label:"Arts"},{color:"#346988",label:"Music"},{color:"#436b0d",label:"Leadership"}].map((t,i)=>(
      ...
      <div style={{position:"relative",zIndex:5,height:"100%",maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",paddingTop:"clamp(140px,16vw,165px)",display:"flex",flexDirection:"column",justifyContent:"flex-end",paddingBottom:"clamp(2.5rem,4.5vw,5rem)"}}>
        <div style={{display:"flex",alignItems:"center",gap:"0.45rem",marginBottom:"clamp(0.8rem,1.5vw,1.25rem)",opacity:loaded?1:0,transition:"all 0.7s ease 0.2s",flexWrap:"wrap"}}>
          ...
          <span style={{color:"#fff",fontSize:"clamp(0.58rem,0.9vw,0.66rem)",letterSpacing:"0.12em",textTransform:"uppercase",fontWeight:600}}>Campus Life</span>
        </div>
        <div style={{display:"inline-flex",alignItems:"center",gap:"0.5rem",background:"rgba(67,107,13,0.3)",border:"1px solid rgba(170,194,12,0.4)",padding:"0.3rem 0.8rem",marginBottom:"clamp(0.6rem,1vw,0.8rem)",alignSelf:"flex-start",opacity:loaded?1:0,transition:"all 0.6s ease 0.3s"}}>
        ...
        <h1 className="font-display" style={{fontSize:"clamp(2.4rem,6.5vw,5rem)",fontWeight:600,lineHeight:1.02,color:"#fff",marginBottom:"0.5rem",opacity:loaded?1:0,transform:loaded?"none":"translateY(22px)",transition:"all 0.8s ease 0.4s"}}>
          Life Beyond<br/><span style={{fontStyle:"italic",color:"var(--accent-light)"}}>the Classroom</span>
        </h1>
        ...
        <p style={{color:"rgba(255,255,255,0.82)",fontSize:"clamp(0.84rem,1.25vw,1rem)",fontWeight:300,maxWidth:520,lineHeight:1.82,marginBottom:"clamp(1.5rem,2.2vw,2.2rem)",opacity:loaded?1:0,transform:loaded?"none":"translateY(18px)",transition:"all 0.8s ease 0.55s"}}>
        ...
        <div style={{display:"flex",gap:"clamp(0.6rem,1vw,0.9rem)",flexWrap:"wrap",opacity:loaded?1:0,transition:"opacity 0.9s ease 0.7s"}}>
          <a href="#activities" onClick={e=>{e.preventDefault();document.getElementById("activities")?.scrollIntoView({behavior:"smooth",block:"start"});}} className="btn-green">Explore Campus</a>
      ...
      <div style={{position:"absolute",bottom:"1.4rem",left:"50%",transform:"translateX(-50%)",display:"flex",gap:6,zIndex:5}}>
        {slides.map((_,i)=>(<button key={i} onClick={()=>setSlide(i)} style={{width:i===slide?"clamp(18px,2.5vw,26px)":"6px",height:"2px",background:i===slide?"var(--secondary)":"rgba(255,255,255,0.5)",border:"none",cursor:"pointer",transition:"all 0.4s",padding:0}}/>))}
      </div>
...
function SectionNav(){
  ...
  return(
    <aside style={{width:"clamp(120px,12vw,180px)",flexShrink:0,position:"sticky",top:110,alignSelf:"flex-start",display:"none"}} className="cl-sidebar">
      ...
      <nav style={{display:"flex",flexDirection:"column",borderLeft:"1px solid #e8e6e3"}}>
        {sections.map((s,i)=>(
          <button key={i} onClick={()=>scrollTo(s.id)} style={{display:"block",padding:"0.55rem 0 0.55rem 1rem",color:active===i?P:"#5a5a5a",background:"none",border:"none",borderLeft:active===i?`2px solid ${P}`:"2px solid transparent",cursor:"pointer",textAlign:"left",fontSize:"0.72rem",fontWeight:active===i?700:400,transition:"all 0.2s",fontFamily:"inherit",marginLeft:"-1px"}}>{s.label}</button>
        ))}
      </nav>
      <div style={{marginTop:"clamp(1.5rem,2vw,2.25rem)",border:"1px solid #e8e6e3",padding:"clamp(1rem,1.5vw,1.4rem)"}}>
        ...
        {[{label:"About Granada",href:"/granada-international/about"},{label:"Admissions",href:"/granada-international/admissions"},{label:"Wellbeing",href:"/granada-international/wellbeing"}].map((l,i)=>(
      ...
      <style>{`@media(min-width:1024px){.cl-sidebar{display:block!important}}`}</style>
    </aside>
  );
}
      ...
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(1rem,2vw,1.5rem)"}} className="mosaic-grid">
          <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(1rem,2vw,1.5rem)"}} className="mosaic-row-1">
            <div className="img-hover" style={{overflow:"hidden",height:"clamp(220px,30vw,380px)",opacity:vis?1:0,transform:vis?"none":"translateX(-20px)",transition:"all 0.9s ease 0.1s"}}>
              <img src="/building.jpeg" alt="Campus Grounds" style={{width:"100%",height:"100%",objectFit:"cover"}}/>
              <div style={{position:"absolute",inset:0,background:"linear-gradient(to top,rgba(52,105,136,0.5),transparent 60%)",display:"flex",alignItems:"flex-end",padding:"1.5rem"}}>
                <p className="font-display" style={{color:"#fff",fontStyle:"italic",fontWeight:400,fontSize:"clamp(0.85rem,1.3vw,1.1rem)"}}>Vipingo, Kilifi County — Kenya Coast</p>
              </div>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(1rem,2vw,1.5rem)"}}>
              {["/sports.jpeg","/building2.jpeg"].map((src,i)=>(
                <div key={i} className="img-hover" style={{overflow:"hidden",height:"clamp(160px,20vw,260px)",opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:`all 0.9s ease ${0.2+i*0.1}s`}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(1.2rem,2vw,1.8rem)"}} className="facilities-grid">
          {facilities.map((f,i)=>(
            <div key={i} style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(1.2rem,2vw,2rem)",alignItems:"center",background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.12)",overflow:"hidden",opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:`all 0.9s ease ${i*0.1}s`}} className="facility-card">
              <div className="img-hover" style={{overflow:"hidden",height:"clamp(180px,22vw,260px)"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(2.5rem,4vw,5rem)",alignItems:"center"}} className="arts-layout">
          <div style={{opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:"all 0.9s ease"}}>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(0.6rem,1vw,0.9rem)"}}>
              <div className="img-hover" style={{overflow:"hidden",height:"clamp(200px,28vw,340px)"}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"clamp(0.6rem,1vw,0.9rem)"}}>
                <div className="img-hover" style={{overflow:"hidden",height:"clamp(90px,12vw,150px)"}}>
      ...
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(2rem,3.5vw,4rem)",alignItems:"center"}} className="music-layout">
          <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(-24px)",transition:"all 0.9s ease 0.1s"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(1rem,1.5vw,1.5rem)"}}>
              {[
                ...
                <div key={i} style={{padding:"clamp(1rem,1.5vw,1.4rem)",background:"#fff",border:"1px solid #e8e6e3",transition:"all 0.3s",cursor:"default"}} onMouseEnter={e=>{(e.currentTarget as HTMLElement).style.borderColor="var(--primary)";(e.currentTarget as HTMLElement).style.boxShadow="0 4px 20px rgba(52,105,136,0.12)";}} onMouseLeave={e=>{(e.currentTarget as HTMLElement).style.borderColor="#e8e6e3";(e.currentTarget as HTMLElement).style.boxShadow="none";}}>
                  <div style={{fontSize:"1.2rem",marginBottom:"0.5rem"}}>{m.icon}</div>
          ...
          <div style={{opacity:vis?1:0,transform:vis?"none":"translateX(24px)",transition:"all 0.9s ease 0.2s"}}>
            <div className="img-hover" style={{overflow:"hidden",height:"clamp(280px,40vw,500px)",marginBottom:"1rem"}}>
            ...
            <div style={{background:"var(--primary)",padding:"clamp(1.2rem,2vw,1.8rem)"}}>
              <p className="font-display" style={{color:"#fff",fontStyle:"italic",fontSize:"clamp(0.9rem,1.3vw,1.1rem)",lineHeight:1.7}}>&ldquo;Music is the universal language that connects minds, cultures, and hearts. At Granada International, it is woven into the very fabric of school life.&rdquo;</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="leadership" className="section-cream" ref={ref} style={{padding:"clamp(3rem,5.5vw,5.5rem) clamp(1rem,2vw,2rem)",scrollMarginTop:"100px"}}>
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:1,background:"#dddbd8",marginBottom:"clamp(2.5rem,4vw,4rem)"}}>
          {programmes.map((p,i)=>(
            <div key={i} style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(1.2rem,2vw,2rem)",alignItems:"start",background:"#fff",padding:"clamp(1.8rem,2.5vw,2.5rem) clamp(1.4rem,2vw,2rem)",borderLeft:`4px solid ${p.color}`,opacity:vis?1:0,transform:vis?"none":"translateX(-20px)",transition:`all 0.9s ease ${i*0.12}s`}} className="leadership-card">
              <div>
                <span style={{display:"inline-block",padding:"0.25rem 0.75rem",background:`${p.color}18`,color:p.color,fontSize:"0.6rem",letterSpacing:"0.18em",textTransform:"uppercase",fontWeight:700,marginBottom:"0.7rem"}}>{p.stage}</span>
        ...
        <div style={{background:"var(--primary)",padding:"clamp(2rem,3.5vw,4rem) clamp(1.5rem,2.5vw,3rem)",textAlign:"center",opacity:vis?1:0,transform:vis?"none":"translateY(24px)",transition:"all 0.9s ease 0.4s"}}>
          <p className="font-display" style={{fontSize:"clamp(1.2rem,2.2vw,1.8rem)",fontStyle:"italic",fontWeight:400,color:"#fff",lineHeight:1.65,maxWidth:720,margin:"0 auto",marginBottom:"1.2rem"}}>
...
function BoardingLife(){
  ...
  return(
    <section id="boarding" ref={ref} className="section-blue" style={{position:"relative",padding:"clamp(3rem,5.5vw,5.5rem) clamp(1rem,2vw,2rem)",scrollMarginTop:"100px",overflow:"hidden"}}>
      ...
      <div style={{position:"absolute",inset:0,background:"rgba(52,105,136,0.93)"}}/>
      <div style={{position:"relative",zIndex:2,maxWidth:1280,margin:"0 auto"}}>
        ...
        <div style={{textAlign:"center",marginTop:"clamp(2rem,3vw,3.5rem)",opacity:vis?1:0,transform:vis?"none":"translateY(20px)",transition:"all 0.9s ease 0.5s"}}>
          <a href="/granada-international/admissions#senior-process" className="btn-green" style={{fontSize:"0.68rem",padding:"0.8rem 2.2rem"}}>Apply to Boarding Senior School</a>
        </div>
      </div>
...
function PageCTA(){
  return(
    <section style={{background:"var(--primary-dark)",padding:"clamp(3rem,5vw,5.5rem) clamp(1rem,2vw,2rem)",textAlign:"center"}}>
      <div style={{maxWidth:700,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",justifyContent:"center",gap:"0.9rem",flexWrap:"wrap"}}>
          <a href="mailto:admissions@granadaschools.group" className="btn-green" style={{fontSize:"0.68rem",padding:"0.75rem 2rem"}}>Book a Campus Tour</a>
      ...
      <div style={{maxWidth:1280,margin:"0 auto"}}>
        <div style={{display:"grid",gridTemplateColumns:"1fr",gap:"clamp(2rem,3vw,3.5rem)",marginBottom:"clamp(2rem,3vw,3rem)"}} className="footer-grid">
          <div>
            ...
            <p style={{color:"rgba(255,255,255,0.6)",fontSize:"0.8rem",lineHeight:1.8,maxWidth:240,marginTop:"1rem"}}>Forward Thinking. Inspiring Excellence. Shaping the Future.</p>
