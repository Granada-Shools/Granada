  ...
  return(
    <section style={{position:"relative",height:"100vh",minHeight:600,overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:5,height:"100%",maxWidth:1280,margin:"0 auto",padding:"0 clamp(1rem,2vw,2rem)",paddingTop:"clamp(140px,16vw,165px)",display:"flex",flexDirection:"column",paddingBottom:"clamp(6rem,4vw,8rem)"}} className="hero-inner">
        ...
        <h1 className="font-display" style={{fontSize:"clamp(1.375rem, 1.3rem + 0.375vw, 1.75rem)",fontWeight:600,lineHeight:1.05,color:"#fff",marginBottom:"0.8rem",alignSelf:"flex-end",maxWidth:"clamp(260px,45vw,520px)",opacity:loaded?1:0,transform:loaded?"translateY(0)":"translateY(20px)",transition:"all 0.8s ease 0.4s"}}>
    ...
    <section className="section-cream" id="history" ref={ref} style={{paddingTop:"clamp(3rem,6vw,5rem)",paddingBottom:"clamp(3rem,6vw,5rem)",scrollMarginTop:"100px"}}>
      ...
      <div>
        <div className="section-float-img" style={{float:"left",margin:"0 1.5rem 1.2rem 0",width:"clamp(260px,38vw,420px)",opacity:vis?1:0,transform:vis?"none":"translateX(-24px)",transition:"all 0.9s ease"}}>
          <div className="img-hover" style={{overflow:"hidden",height:"clamp(320px,50vw,400px)"}}>
            <img src="/class.jpeg" alt="" style={{width:"100%",height:"100%",objectFit:"cover"}}/>
          </div>
        </div>
