          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",borderRight:"1px solid rgba(255,255,255,0.1)",background:"#213558"}}>
            ...
            <div style={{flex:1,overflowY:"auto",padding:"1.25rem 1.5rem"}}>
              ...
              <div style={{display:"flex",gap:"0.6rem",marginTop:"1.5rem",flexWrap:"wrap"}}>
                ...
                <a href="/granada-school/admissions#process" onClick={onClose} style={{fontSize:"clamp(0.55rem,0.78vw,0.62rem)",padding:"0.45rem 1.2rem",background:"transparent",color:"#fff",border:`1px solid ${S}`,textDecoration:"none",cursor:"pointer",transition:"all 0.2s"}} onMouseEnter={e=>{e.currentTarget.style.background=S;e.currentTarget.style.color=P;}} onMouseLeave={e=>{e.currentTarget.style.background="transparent";e.currentTarget.style.color="#fff";}}>Apply Now</a>
              </div>
            </div>
          </div>
          {/* Right column - Image */}
